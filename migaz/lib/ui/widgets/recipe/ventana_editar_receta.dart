...
class _DialogoEditarRecetaState extends State<DialogoEditarReceta> {
  ...
  void _inicializarControllers() {
    _nombreController = TextEditingController(text: widget.recetaOriginal.nombre);
    _descripcionController = TextEditingController(text: widget.recetaOriginal.descripcion);
    _tiempoController = TextEditingController(text: widget.recetaOriginal.tiempo);
    _servingsController = TextEditingController(text: widget.recetaOriginal.comensales.toString());
    _ingredienteInputController = TextEditingController();
    _pasoInputController = TextEditingController();
    _youtubeController = TextEditingController(text: widget.recetaOriginal.youtube ?? '');
  ...
  Future<void> _cargarCategorias() async {
    try {
      ...
      setState(() {
        ...
        // Verificar si la categoría actual existe en la lista
        if (!_categorias.contains(_categoriaSeleccionada) && _categorias.isNotEmpty) {
